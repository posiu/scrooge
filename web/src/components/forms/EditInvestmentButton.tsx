          ...
          <div className="bg-card border border-border rounded-2xl w-full max-w-md shadow-2xl text-left">
            ...
            <form onSubmit={handleSubmit} className="p-5 space-y-4">
              <div>
                ...
                <input name="name" required defaultValue={investment.name} placeholder={t('namePlaceholder')} className="w-full px-3 py-2 rounded-lg border border-border bg-background text-sm focus:outline-none focus:ring-2 focus:ring-[#01581E]" />
              </div>
              <div>
              ...
              <div>
                ...
                <input name="institution" defaultValue={investment.institution ?? ''} placeholder={t('institutionPlaceholder')} className="w-full px-3 py-2 rounded-lg border border-border bg-background text-sm focus:outline-none focus:ring-2 focus:ring-[#01581E]" />
              </div>
              <div>
                <label className="text-xs font-medium text-foreground block mb-1.5">{t('descriptionLabel')}</label>
                <input name="description" defaultValue={investment.description ?? ''} placeholder={t('descriptionPlaceholder')} className="w-full px-3 py-2 rounded-lg border border-border bg-background text-sm focus:outline-none focus:ring-2 focus:ring-[#01581E]" />
              </div>
